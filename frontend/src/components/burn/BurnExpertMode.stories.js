...
function renderWithReactive(args) {
  return {
    ...
    template: '<BurnExpertMode v-bind="args" />',
  }
}

export default {
  title: 'Burn/BurnExpertMode',
  component: BurnExpertMode,
